...
public class DownloadController {
    ...
    @Autowired
    public DownloadController(PhotoService photoService) { this.photoService = photoService; }
    ...
    public ResponseEntity<byte[]> download(@PathVariable Long id){
        ...
        headers.setContentType(MediaType.valueOf(photo.get().getMimeType()));
        //tell the browser to download it directly
